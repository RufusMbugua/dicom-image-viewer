...
;angular.module('div').controller('backendCtrl', ['$scope', 'Requests',
  '$state',
...
;angular.module("div").directive('pushMenu', ['$rootScope', '$timeout',
  function(rootScope,
    timeout) {
    return {
      restrict: 'A',
...
;angular.module("div").directive('rmValidate', ['$rootScope', '$timeout',
  function(rootScope,
    timeout) {
    return {
      restrict: 'A',
...
;;angular.module('div').controller('questionsCtrl', ['$scope', 'Requests',
  '$state',
  function(scope, Requests, state) {
    scope.responses = []
    scope.question = {}
...
;;angular.module('div').directive('qTable', function() {
  return {
...
angular.module('div').directive('qDash', function() {
  return {
    controller: 'questionsCtrl',
    // transclude: true,
